...
ARCANA_OWNER_EMAIL="${LOCAL_SMOKE_OWNER_EMAIL:-${ARCANA_OWNER_EMAIL:-}}" \
ARCANA_OWNER_PASSWORD="${LOCAL_SMOKE_OWNER_PASSWORD:-${ARCANA_OWNER_PASSWORD:-}}" \
ARCANA_OWNER_MFA_SECRET="${LOCAL_SMOKE_OWNER_MFA_SECRET:-${ARCANA_OWNER_MFA_SECRET:-}}" \
ARCANA_OWNER_MFA_CODE="${LOCAL_SMOKE_OWNER_MFA_CODE:-${ARCANA_OWNER_MFA_CODE:-}}" \
